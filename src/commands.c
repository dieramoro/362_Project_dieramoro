...
void ghero(int argc, char *argv[])
{
    //const char str[] = Guitar_hero_logo;
    //puts(str);
}
...
void drawexamp(){
    LCD_Clear(0);
    //int input[6] = {'drawfillrect', '0', '0', '200', '200', '0f0f'};
    //drawfillrect(6, input);
    //uint16_t
    //int fillArray[6] = {0, 0, 0, 200, 200, 0x0F0F0};
    //int NUM = 6;
    //int x1 = strtoul('0', 0, 10);
    //int y1 = strtoul('0', 0, 10);
    //int x2 = strtoul('200', 0, 10);
    //int y2 = strtoul('200', 0, 10);
    //int c = strtoul('0', 0, 16);
    //drawfillrect(NUM, fillArray);
    //LCD_DrawLine(x1,y1,x2,y2,c);
    /*x1 = strtoul(1, 0, 10);
    y1 = strtoul(0, 0, 10);
    x2 = strtoul(200, 0, 10);
